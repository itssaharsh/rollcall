...
export default function NotFound() {
  return (
    <main className="flex min-h-dvh flex-col items-center justify-center gap-5 p-6 text-center">
      ...
      <Link href="/" className="inline-flex h-10 items-center rounded-md bg-accent px-4 font-semibold text-accent-ink transition-colors duration-150 hover:bg-accent-hover">Back to the console</Link>
    </main>
  )
}
