...
export default function About() {
  ...
  return (
    <main className="mx-auto max-w-[720px] px-5 py-10 sm:py-16">
      ...
      <p className="mt-3">The No Surprises Act already requires plans to verify directory data every 90 days. The <a className="text-accent underline underline-offset-2" href="https://www.ama-assn.org/health-care-advocacy/access-care/more-accurate-medicare-advantage-provider-directory-way">REAL Health Providers Act</a>, signed in February 2026, makes Medicare Advantage plans re-verify every 90 days, remove departed providers within five business days and publish accuracy scores, from plan year 2028. And <a className="text-accent underline underline-offset-2" href="https://ccf.georgetown.edu/2024/05/15/a-closer-look-at-the-access-provisions-in-final-medicaid-managed-care-rule/">CMS requires every state</a> to run annual secret-shopper surveys of Medicaid managed-care directories from July 2028. Today that work is a call centre asking the same five questions. One vendor in this market puts a manual verification call at <a className="text-accent underline underline-offset-2" href="https://www.hilabs.com/blog/ai-voice-agent-for-healthcare-provider-data-verification">“several dollars per interaction”</a>; the recorded calls on the console cost about eight cents each.</p>
